...
def generate_and_download_images(growth_df=None):
    ...
    ax2.axhline(y=2000000, color='red', linestyle='--', linewidth=1.5, label="2M เกณฑ์", zorder=4)
    ax2.axhline(y=1000000, color='#00BFFF', linestyle='--', linewidth=1.5, label="1M เกณฑ์", zorder=4)
